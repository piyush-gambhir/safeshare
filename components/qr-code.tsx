...
export default function QRCode({ value, size = 200, bgColor = "#ffffff", fgColor = "#000000", logoUrl }: QRCodeProps) {
  ...
  return <canvas ref={canvasRef} width={size} height={size} className="rounded-lg shadow-sm" />
}
